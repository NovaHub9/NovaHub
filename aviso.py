...
async def actualizar_menu(guild_id: str):
    ...
    embed.set_image(url="https://cdn.discordapp.com/attachments/1398867717871767582/1441978459852378175/standard_3.gif?ex=69246b57&is=692319d7&hm=aeb7e698699e6e9754b3f16e7b55a1438a59dd4b61dcecfb43e1e56d61ef753f&")
...
async def addscripts(interaction: discord.Interaction, name: str, desc: str, code: str):
    ...
    # Actualiza el menú automáticamente
